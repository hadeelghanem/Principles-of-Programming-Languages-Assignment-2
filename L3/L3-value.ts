...
// Added functions to create Class and Object values
...
export const makeObjectEnv = (methods: Binding[], env: Env): Object =>
  ...
  // Add type predicates for Class and Object
...
export type SExpValue = number | boolean | string | PrimOp | Closure | Class | Object | SymbolSExp | EmptySExp | CompoundSExp ;
